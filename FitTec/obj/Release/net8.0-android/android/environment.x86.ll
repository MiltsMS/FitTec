...
@dso_cache = dso_local local_unnamed_addr global [574 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 1015129670, ; hash 0x3c81a646, from name: libaot-FitTec.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1531312141, ; hash 0x5b45f80d, from name: libaot-FitTec
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-FitTec.dll.so
		ptr null; void* handle (0x0)
	}, ; 192
	...
	%struct.DSOCacheEntry {
		i64 1718745236, ; hash 0x6671f894, from name: FitTec.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-FitTec.dll.so
		ptr null; void* handle (0x0)
	}, ; 207
	...
	%struct.DSOCacheEntry {
		i64 1814912181, ; hash 0x6c2d5cb5, from name: aot-FitTec
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-FitTec.dll.so
		ptr null; void* handle (0x0)
	}, ; 224
	...
	%struct.DSOCacheEntry {
		i64 3751759347, ; hash 0xdf9f4df3, from name: aot-FitTec.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-FitTec.dll.so
		ptr null; void* handle (0x0)
	}, ; 501
	...
	%struct.DSOCacheEntry {
		i64 4235680421, ; hash 0xfc775aa5, from name: FitTec
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-FitTec.dll.so
		ptr null; void* handle (0x0)
	}, ; 565
