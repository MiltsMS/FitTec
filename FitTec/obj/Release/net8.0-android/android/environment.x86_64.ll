...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 100670878, ; uint32_t jnienv_initialize_method_token (0x6001d9e)
	i32 100670877, ; uint32_t jnienv_registerjninatives_method_token (0x6001d9d)
...
@dso_cache = dso_local local_unnamed_addr global [574 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 1518247700891569200, ; hash 0x1511e63d6cb20c30, from name: FitTec.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-FitTec.dll.so
		ptr null; void* handle (0x0)
	}, ; 48
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 3295002033441613884, ; hash 0x2dba32e4497a283c, from name: FitTec
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-FitTec.dll.so
		ptr null; void* handle (0x0)
	}, ; 105
	...
	%struct.DSOCacheEntry {
		i64 8218100021235961618, ; hash 0x720c8e6d8e664f12, from name: aot-FitTec
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-FitTec.dll.so
		ptr null; void* handle (0x0)
	}, ; 243
	...
	%struct.DSOCacheEntry {
		i64 13583921723798056504, ; hash 0xbc83c8d64bb1ee38, from name: aot-FitTec.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-FitTec.dll.so
		ptr null; void* handle (0x0)
	}, ; 427
	...
	%struct.DSOCacheEntry {
		i64 15406962809438384907, ; hash 0xd5d0870bac3ab30b, from name: libaot-FitTec.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-FitTec.dll.so
		ptr null; void* handle (0x0)
	}, ; 482
	...
	%struct.DSOCacheEntry {
		i64 15915951758065990378, ; hash 0xdce0d1cc31c6faea, from name: libaot-FitTec
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-FitTec.dll.so
		ptr null; void* handle (0x0)
	}, ; 497
...
@.env.3 = private unnamed_addr constant [37 x i8] c"dcb2106a-f6c7-4a6f-aab9-4b81525dbca1\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [23 x i8] c"com.companyname.fittec\00", align 16
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [21 x i8] c"libaot-FitTec.dll.so\00", align 16
